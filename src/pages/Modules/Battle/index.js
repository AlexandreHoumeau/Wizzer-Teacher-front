      ...
      <div className="flex space-x-4 mb-4">
        <div
          ...
          className={classNames(
            ...
            view === 'todayExercices' ? 'bg-primary text-white' : 'bg-grey-light text-black'
          )}
        >
          Cours de la battle
        </div>
        <div
          ...
          className={classNames(
            "text-lg font-medium rounded-lg px-4 py-2 cursor-pointer",
            view === 'onGoingBattle' ? 'bg-primary text-white' : 'bg-grey-light text-black'
          )}        >
        ...
        <div
          ...
          className={classNames(
            "text-lg font-medium rounded-lg px-4 py-2 cursor-pointer",
            view === 'history' ? 'bg-primary text-white' : 'bg-grey-light text-black'
          )}        >
